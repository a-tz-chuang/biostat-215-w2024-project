...
```{r}
full_model_formula <- Surv(dtime, death) ~ age*chemo + meno + size*nodes + 
  grade + pgr + er*hormon
...
PA_stats <- data.frame(
  ...
  C_type = c("uno", "uno", "uno", "harrel", "harrel", "uno"),
  C_value = c(
...
myCalPlotSettings <- function(model, legend.label = "Predicted survival", ...) {
  pec::calPlot(model, time=t, data=rotterdam_test, method = "quantile",
               q = 10, bars=TRUE, type="survival", pseudo=FALSE,
               legend.legend = c(legend.label, "Observed frequencies"), ...)
}
```
...
myCalPlotSettings5year <- function(model, legend.label = "Predicted survival", ...) {
  pec::calPlot(model, time=fiveyear, data=rotterdam_test, method = "quantile",
               q = 10, bars=TRUE, type="survival", pseudo=FALSE,
               legend.legend = c(legend.label, "Observed frequencies"), ...)
}

myCalPlotSettings10year <- function(model, legend.label = "Predicted survival", ...) {
  pec::calPlot(model, time=tenyear, data=rotterdam_test, method = "quantile",
               q = 10, bars=TRUE, type="survival", pseudo=FALSE,
               legend.legend = c(legend.label, "Observed frequencies"), ...)
}
```
...
```{r}
myCalPlotSettings(weiAFT_sbAIC, "Weibull AFT Prediction")
myCalPlotSettings5year(weiAFT_sbAIC, "Weibull AFT Prediction")
myCalPlotSettings10year(weiAFT_sbAIC, "Weibull AFT Prediction")
```

## Exponential AFT Calibration Plots

```{r}
myCalPlotSettings(exAFT_sbAIC, "Exponential AFT Prediction")
myCalPlotSettings5year(exAFT_sbAIC, "Exponential AFT Prediction")
myCalPlotSettings10year(exAFT_sbAIC, "Exponential AFT Prediction")
```

## Lognormal AFT Calibration Plots

```{r}
myCalPlotSettings(lognormAFT_sbAIC, "Lognormal AFT Prediction")
myCalPlotSettings5year(lognormAFT_sbAIC, "Lognormal AFT Prediction")
myCalPlotSettings10year(lognormAFT_sbAIC, "Lognormal AFT Prediction")
```

## Cox LASSO Calibration Plots

```{r}
myCalPlotSettings(lasso_temp, "Cox LASSO Prediction",formula = full_model_formula)
myCalPlotSettings5year(lasso_temp, "Cox LASSO Prediction",formula = full_model_formula)
myCalPlotSettings10year(lasso_temp, "Cox LASSO Prediction",formula = full_model_formula)
```
## Cox Stepwise Forward AIC Calibration Plots

```{r}
myCalPlotSettings(rot_sfAIC, "Cox Stepwise Forward AIC Prediction")
myCalPlotSettings5year(rot_sfAIC, "Cox Stepwise Forward AIC Prediction")
myCalPlotSettings10year(rot_sfAIC, "Cox Stepwise Forward AIC Prediction")
```

## Cox Stepwise Forward BIC Calibration Plots

```{r}
myCalPlotSettings(rot_sfBIC, "Cox Stepwise Forward BIC Prediction")
myCalPlotSettings5year(rot_sfBIC, "Cox Stepwise Forward BIC Prediction")
myCalPlotSettings10year(rot_sfBIC, "Cox Stepwise Forward BIC Prediction")
```

## Cox PH Calibration Plot

```{r}
myCalPlotSettings(fit.coxph, "Cox PH Prediction")
```
