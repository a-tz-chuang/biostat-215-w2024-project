...
rot_sfAIC <- stepAIC(survreg(null_model_formula, data = rotterdam_train,
...
```{r AIC_selection}
rot_sbAIC <- stepAIC(survreg(full_model_formula,
...
rot_sfBIC <- stepAIC(survreg(null_model_formula, data = rotterdam_train,
                             dist = "lognormal", x = TRUE, y = TRUE),
                     full_model_formula,
...
rot_sbBIC <- stepAIC(survreg(full_model_formula,
                             data = rotterdam_train,
                             dist = "lognormal", x = TRUE, y = TRUE),
                     full_model_formula,
