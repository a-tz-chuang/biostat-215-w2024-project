...
a <- rbind(c(yr5 = ND.chisquare.test(weiAFT_sbAIC.5year), yr10 = ND.chisquare.test(weiAFT_sbAIC.10year)), 
           ...
           c(ND.chisquare.test(lognormAFT_sbAIC.5year), ND.chisquare.test(lognormAFT_sbAIC.10year)), c(ND.chisquare.test(lasso_temp.5year), ND.chisquare.test(lasso_temp.10year)), c(ND.chisquare.test(rot_sfAIC.5year), ND.chisquare.test(rot_sfAIC.10year)), c(ND.chisquare.test(rot_sfAIC.5year), ND.chisquare.test(rot_sfBIC.10year)))
